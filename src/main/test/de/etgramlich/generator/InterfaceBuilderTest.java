...
class InterfaceBuilderTest {
    ...
    void renderInterface_interfaceNoParentsTwoMethodsNoArguments() {
        final Set<de.etgramlich.generator.Method> methods = Set.of(
                new de.etgramlich.generator.Method("int", "getX"),
                new de.etgramlich.generator.Method("int", "getY")
        );
    ...
    void renderInterface_interfaceNoParentsTwoMethodsTwoArgumentsEach() {
        final Set<de.etgramlich.generator.Method> methods = Set.of(
                new de.etgramlich.generator.Method("int", "getX", List.of(
                        new Argument("int", "a"),
                        new Argument("int", "b")
                )),
                new de.etgramlich.generator.Method("int", "getY", List.of(
                        new Argument("int", "a"),
                        new Argument("int", "b")
                ))
        );
